...
export default function ShoppingCart() {
  ...
  useEffect(()=>{
    ...
    const currentCart = JSON.parse(getCartItem);
    setProduct(currentCart);

  }, []);

  product.forEach(item => {
    let numberWithoutCommas = item['price'].replace(/,/g, '');
    let number = parseInt(numberWithoutCommas);
    totalPrice += number;
  });
        ...
        <div className="fixed inset-0 overflow-hidden">
          <div className="absolute inset-0 overflow-hidden">
            <div className="pointer-events-none fixed inset-y-0 right-0 flex max-w-full pl-10">
              ...
              >
                <Dialog.Panel className="mt-20 pointer-events-auto w-screen max-w-md">
                  <div className="flex h-full flex-col bg-white shadow-xl">
                    <div className="flex-1 overflow-y-auto px-4 py-6 sm:px-6">
                      ...
                      <div className="mt-8 max-h-[250px] overflow-y-scroll">
