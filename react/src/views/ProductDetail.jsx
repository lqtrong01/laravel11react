...
export default function ProductDetail() {
  ...
  const addToCart=(ev, data)=>{
    if(!userToken){
      addToCartCookie(data);
    }
    else {
      createCart(data);
    }
  ...
  return (
    <div>
      ...
      {products.map((data) => (
        <div className="pt-6">
          {/* Image gallery */}
          <div className="mx-auto mt-6 grid-flow-row flex justify-center">
